package com.roy93group.cintalauncher.providers.color.pallete
...
class BitmapBasedPalette(
    ...
    init {
        ...
        val darkNeutralSwatch =
            wallpaper.darkVibrantSwatch ?: wallpaper.darkMutedSwatch ?: wallpaper.dominantSwatch
        val darkNeutral = darkNeutralSwatch?.rgb
        lab.run {
            ColorUtils.colorToLAB(/* color = */ darkNeutral ?: 0, /* outLab = */ this)
            ...
            neutralVeryDark = ColorUtils.LABToColor(
                /* l = */ this[0],
                /* a = */this[1],
                /* b = */this[2]
            )
        ...
        val lightNeutralSwatch =
            wallpaper.lightVibrantSwatch ?: wallpaper.lightMutedSwatch ?: wallpaper.dominantSwatch
        ...
        val mediumNeutral = ColorUtils.blendARGB(
            /* color1 = */ darkNeutral ?: 0xffffffff.toInt(),
            /* color2 = */ lightNeutral ?: 0xff000000.toInt(),
            /* ratio = */ 0.5f
        )
        lab.run {
        ...
        lab.run {
            ColorUtils.colorToLAB(/* color = */ primarySwatch?.rgb ?: 0, /* outLab = */ this)
        ...
        lab.run {
            ...
            this[2] *= 2.0
            secondary =
                ColorUtils.LABToColor(/* l = */ this[0], /* a = */ this[1], /* b = */ this[2])
        }
    }
}
